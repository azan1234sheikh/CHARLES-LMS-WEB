       ...
       minW="675px" mb="160px" h="700px" >
        ...
        <Text  mb="3" color="background: rgba(20, 21, 34, 1);" fontWeight="500" fontSize="42px" letterSpacing="2px" lineHeight="63px" fontFamily="'Plus Jakarta Sans', sans-serif">
          ...
          <Text mb="3" color="background: rgba(20, 21, 34, 1);" fontWeight="400" fontSize="14px" lineHeight="28px" fontFamily="'Plus Jakarta Sans', sans-serif">
            New User? <Button onClick={handleSignupClick}  _hover={{ border: "1px solid #d7d7d7"  }} border="1px solid Transparent" bg="transparent"><span style={{color: 'rgba(4, 164, 244, 1)', fontWeight: 500, fontSize: '14px', lineHeight: '21px', fontFamily: "'Plus Jakarta Sans', sans-serif"}}>
...
"         mt="9" 
        ...
        />
         ...
         h="50px"
         bg="white"
         leftIcon={<Image w="16px" h="16px" src="./public/ic_google logo.png" alt="Logo" boxSize="24px" />}
         borderRadius="10px"
         fontFamily="'Plus Jakarta Sans', sans-serif"
         ...
         h="50px"
         bg="white"
         leftIcon={<Image w="16px" h="16px" src="./public/ic_fb logo.png" alt="Logo" boxSize="24px" />}
         borderRadius="10px"
         fontFamily="'Plus Jakarta Sans', sans-serif"
         border="1px  solid rgba(235, 234, 237, 1)"
         fontWeight="500"
